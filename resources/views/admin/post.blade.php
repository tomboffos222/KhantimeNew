...
@section('content')
    <div class="col-lg-12">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2">Создать дочернию категорию</button>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.SubCat')}}" method="get">
                            <div class="">
                                <input type="text" name="title" class="form-control" placeholder="Ваша категория">


                                <select name="parent_id" id="" class="mt-5" style="margin-top:50px;">
                                    @foreach($cats as $cat)
