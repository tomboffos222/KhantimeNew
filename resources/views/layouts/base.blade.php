...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-166977452-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  	gtag('js', new Date());

  	gtag('config', 'UA-166977452-1');
	</script>
    <!-- Meta tags -->
    <meta charset="utf-8">
        ...
        <div class="sidebar-inner">
            ...
            <div class="sidebar-widget">
                ...
                <ul class="menu" id="sidebar-menu">
                    ...
                    <li class="menu-item menu-item-has-children"><a href="{{route('Home')}}">Категории</a>
                        <ul class="sub-menu">
                            @foreach($cats as $cat)
                                ...
                                <div class="alith_latest_trading_img_position_relative">
                                    ...
                                    <div class="alith_post_title_small">
                                        <a href="{{route('Article',$newArticle->id)}}"><strong>@php
                                                    echo mb_strimwidth($newArticle['title'],0,80,'...');
                                                @endphp</strong></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-12 main_nav_cover" id="nav">
                                <ul id="main-menu">
                                    <li class="menu-item-has-children"><a href="{{route('Home')}}">Категории</a>
                                        <ul class="sub-menu">
                                            @foreach($cats as $cat)
                                            <li class="menu-item-has-children">
                                                <a href="{{route('ArticleCategory',$cat->id)}}">
                                                    {{$cat->name}}
                                                </a>
                                                <ul class="sub-menu">
                        ...
                        <div class="owl-carousel owl-theme js carausel_slider section_margin" id="slider-small">
                            ...
                            <div class="item px-2">
                                <div class="alith_latest_trading_img_position_relative" style="height:100px;">
                                    ...
                                    <div class="alith_post_title_small">
                                        <a href="{{route('Article',$newArticle->id)}}"><strong>@php
                                                    echo mb_strimwidth($newArticle['title'],0,55,'...');
                                                @endphp</strong>
                        ...
                        <div class="col-12 col-md-12 bottom-logo">
                            ...
                            <div class="tagline social">
                                <ul>
                                    ...
                                    <li class="google-plus"><a href="https://t.me/thekhantime"><i class="fa fa-envelope "></i></a></li>
