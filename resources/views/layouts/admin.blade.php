...
<section >
    ...
    <aside id="leftsidebar" class="sidebar" style="background-color: #ececec;">
        ...
        <div class="user-info">
            <div class="image">
                <img src="{{asset('assets/images/favicon/apple-icon-180x180.png')}}" style="border-radius:0px !important;" type="image/png" width="48" height="48" alt="User" />
            ...
            <div class="info-container" style="color:#000;">
                ...
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:#000;">Выйти</div>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                 ...
                 <li>
                    <a href="{{route('admin.ArticleCategories')}}">
