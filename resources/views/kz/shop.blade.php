...
@section('content')
    ...
    <div class="container">
        ...
        <div id="messages" >
            <form id="search_form" method="get" action="{{Route('kz.SearchProduct')}}">
        ...
        <div class="" style="font-size: 25px;">
            ...
            <span style="font-size:20px;">Корзина</span>
        ...
        <div class="">
            <div class="col-md-12 col-xs-12 left-block">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb"><li><a href="/">Үйге
                                </a></li><li class="active">ДҮКЕН</li></ul>
                    </div>
                    @foreach($products as $product)
                    <div class="col-md-4 col-xs-6 col-sm-6 product">
                        <a href="{{Route('kz.Product',$product->id)}}" title="{{$product->description}}">
                            <img class="img-responsive" alt="" style="height: 200px;width: 100%;" src="{!! $product->img !!}">
                        </a>
                        <div class="info">
                            <h3><a href="{{Route('kz.Product',$product->id)}}" title="">
                            ...
                            <p></p>
                            <button class="btn btn-default my-cart-btn" data-id="{{$product->id}}" data-id_real="{{$product->id}}" data-name="{{$product->title}}" data-summary="{{$product->price}}" data-price="{{$product->price}}" data-quantity="1" data-image="{!! $product->img !!}">Себетке</button>
